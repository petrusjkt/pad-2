<template>
        ...
        <div :class="$style.body">
          <div :class="$style.illustration">
            <div :class="$style.frame">
              ...
              <img :class="$style.shapeIcon1" alt="" src="/shape1@2x.png" />
            </div>
          </div>
  ...
  <style module>
    ...
    .lookAgainAt {
      width: 392px;
      position: relative;
      font-size: var(--light-components-button-medium-size);
    ...
    .labelContainer {
      background-color: var(--light-secondary-contrast);
      height: 2px;
      display: none;
      flex-direction: row;
      align-items: center;
    ...
    .text {
      ...
      align-items: flex-start;
      justify-content: flex-start;
      font-size: var(--light-typography-caption-size);
      color: var(--light-text-secondary);
    }
    .card {
      position: absolute;
    ...
    .resetKataSandi {
      ...
      color: var(--light-text-primary);
      font-family: var(--light-components-chip);
    }
  </style>
